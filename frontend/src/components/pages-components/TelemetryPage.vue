<script setup>
    ...
    const props = defineProps({carData: {type: Object, default: null}})
    ...
    const getOilTemp = computed(() => {
        return props.carData.engine_oil_temp
    });

    const brakeTemp = computed(() => {
        return props.carData.brake_temperature
    });
        ...
        <v-row class="flex-grow-1">
            <v-col :cols="cols[0]">
                ...
                >
                    <template #default>
                        <CarOdometer 
                            :speed="props.carData.speed"
                            :rpm="props.carData.rpm"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <OilPressure
                                        class="pa-0 ma-0"
                                        :oil-pressure="props.carData.oil_pressure"
                                        :team-theme="teamColor"
                                    />
                                </v-col>
                            </v-row>
        ...
        <v-row class="flex-grow-1">
            <v-col :cols="cols[0]">
                ...
                >
                    <template #default>
                        <TiresStatus 
                            :front-left-health="props.carData.tire_health_fl"
                            :front-right-health="props.carData.tire_health_fr"
                            :rear-left-health="props.carData.tire_health_rl"
                            :rear-right-health="props.carData.tire_health_rr"
                            :tire-type="props.carData.tire_type"
                            :team-theme="teamColor"
                        />
                    </template>
                </UiSheet>
                ...
                <template #default> 
                    ...
                    >
                        <div class="d-flex flex-row align-items w-100">
                            ...
                            <CarAutonomy
                                class="flex-grow-0"
                                :fuel="props.carData.fuel_level"
                                :esr-percentage="props.carData.battery_level"
                                :team-theme="teamColor"
                            />
                        </div>
                    </UiSheet>
