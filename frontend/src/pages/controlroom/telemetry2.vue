        ...
        <v-row class="flex-grow-1">
            <v-col :cols="cols[0]">
                ...
                >
                    <template #default>
                        <TiresStatus 
                            :front-left-health="carData2.tire_health_fl"
                            :front-right-health="carData2.tire_health_fr"
                            :rear-left-health="carData2.tire_health_rl"
                            :rear-right-health="carData2.tire_health_rr"
                            :tire-type="carData2.tire_type"
                            :team-theme="teamColor"
                        />
                    </template>
                </UiSheet>
                ...
                <template #default> 
                    ...
                    >
                        <div class="d-flex flex-row align-items w-100">
                            ...
                            <CarAutonomy
                                class="flex-grow-0"
                                :fuel="carData2.fuel_level"
                                :esr-percentage="carData2.battery_level"
                                :team-theme="teamColor"
                            />
                        </div>
                    </UiSheet>
