...
<template>
  <v-container>
    <v-card elevation="4" class="pa-6 mx-auto" max-width="600">
      <v-card-title class="text-h5 mb-6">Il tuo profilo</v-card-title>
      ...
      <v-card-subtitle class="text-h6 mb-4">Cambia password</v-card-subtitle>
