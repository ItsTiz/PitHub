export function getTeamColor(teamName, darken = false) {
    ...
    if (cleanName.includes('red bull') || cleanName.includes('rbpt')) return darken ? 'redbull' : 'redbull-darken-1';
    ...
    if (cleanName.includes('aston martin')) return darken ? 'astonmartin' : 'astonmartin-darken-1';
