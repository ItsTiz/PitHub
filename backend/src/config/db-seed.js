...
const gridData = [
    {
        ...
        drivers: [
            { full_name: 'Charles Leclerc', dob: 1997, nationality: 'Monegasque', height: 180, weight: 69 },
            { full_name: 'Lewis Hamilton', dob: 1985, nationality: 'British', height: 174, weight: 73 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Max Verstappen', dob: 1997, nationality: 'Dutch', height: 181, weight: 72 },
            { full_name: 'Liam Lawson', dob: 2002, nationality: 'New Zealander', height: 174, weight: 68 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Lando Norris', dob: 1999, nationality: 'British', height: 170, weight: 68 },
            { full_name: 'Oscar Piastri', dob: 2001, nationality: 'Australian', height: 178, weight: 68 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'George Russell', dob: 1998, nationality: 'British', height: 185, weight: 70 },
            { full_name: 'Kimi Antonelli', dob: 2006, nationality: 'Italian', height: 172, weight: 65 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Fernando Alonso', dob: 1981, nationality: 'Spanish', height: 171, weight: 68 },
            { full_name: 'Lance Stroll', dob: 1998, nationality: 'Canadian', height: 182, weight: 70 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Pierre Gasly', dob: 1996, nationality: 'French', height: 177, weight: 70 },
            { full_name: 'Jack Doohan', dob: 2003, nationality: 'Australian', height: 176, weight: 69 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Alex Albon', dob: 1996, nationality: 'Thai', height: 186, weight: 73 },
            { full_name: 'Carlos Sainz', dob: 1994, nationality: 'Spanish', height: 178, weight: 66 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Nico Hulkenberg', dob: 1987, nationality: 'German', height: 184, weight: 78 },
            { full_name: 'Gabriel Bortoleto', dob: 2004, nationality: 'Brazilian', height: 175, weight: 68 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Yuki Tsunoda', dob: 2000, nationality: 'Japanese', height: 159, weight: 54 },
            { full_name: 'Isack Hadjar', dob: 2004, nationality: 'French', height: 174, weight: 65 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Esteban Ocon', dob: 1996, nationality: 'French', height: 186, weight: 66 },
            { full_name: 'Oliver Bearman', dob: 2005, nationality: 'British', height: 184, weight: 70 }
        ],
    ...
    },
    {
        ...
        drivers: [
            { full_name: 'Colton Herta', dob: 2000, nationality: 'American', height: 176, weight: 69 },
            { full_name: 'Valtteri Bottas', dob: 1989, nationality: 'Finnish', height: 173, weight: 69 }
        ],
